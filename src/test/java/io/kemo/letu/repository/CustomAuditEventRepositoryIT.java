package io.kemo.letu.repository;

import io.kemo.letu.LetuserverApp;
import io.kemo.letu.config.Constants;
import io.kemo.letu.config.audit.AuditEventConverter;
import io.kemo.letu.domain.PersistentAuditEvent;
...
import static io.kemo.letu.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
